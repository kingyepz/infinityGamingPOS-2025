...
const navItems = [
  ...
  { href: '/stations', label: 'Stations', icon: Tv, roles: ['admin', 'supervisor'] },
  { href: '/games', label: 'Games', icon: Album, roles: ['admin', 'supervisor'] },
  { href: '/payments', label: 'Payments', icon: CreditCard, roles: ['admin', 'cashier', 'supervisor'], comingSoon: true },
